...
class AletPaymentAwash
{
    ...
    {
        try {
            $response = $this->http_client->post(AletPayment::API_VERSION."/checkout/awash/direct/transfer", [
                RequestOptions::JSON => [
    ...
    {
        try {
            $response = $this->http_client->post(AletPayment::API_VERSION."/checkout/awash/direct/verifyOTP", [
                RequestOptions::JSON => [
                    "sessionId" => $checksessionID,
