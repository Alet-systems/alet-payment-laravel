...
class AletPaymentTransaction implements JsonSerializable
{
    ...
    {
        return new AletPaymentTransaction($data["id"], $data["transactionId"], $data["paymentType"], $data["transactionStatus"], $data["createdAt"], $data["updatedAt"]);
    }
}
